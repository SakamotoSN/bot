...
if (message.content === "Koro!travaille"){ //koro
    message.channel.send("Je corrige et prépare vos interrogations", {
        file: "https://media.giphy.com/media/133FgIVnM1g70k/giphy.gif"
    });
}
...
if (message.content === "Xarrin!gral"){
